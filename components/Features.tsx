...
// Extend types for vendor-specific properties
...
const Features: React.FC = () => {
  ...
  const toggleFullscreen = (e: React.MouseEvent) => {
    ...
    const container = videoContainerRef.current as WebKitHTMLElement | null;
    const doc = document as WebKitDocument;

    if (!video || !container) return;

    if (video.webkitEnterFullscreen && !doc.fullscreenEnabled && !doc.webkitFullscreenEnabled) {
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            >
              ...
              >
                <source src="/videos/racan-look.mov" type="video/quicktime" />
                <source src="/videos/racan-look.mov" type="video/mp4" />
              ...
              >
                <div className="w-24 h-24 md:w-28 md:h-28 rounded-full bg-black/60 backdrop-blur-xl border border-white/10 flex items-center justify-center shadow-[0_0_50px_rgba(0,0,0,0.5)] transition-transform group-hover/video:scale-105">
                  <div className="opacity-80 w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-white/10 to-transparent flex items-center justify-center">
                    {isPlaying ? (
