  ...
  <div className="relative w-full h-[200px] sm:h-[240px] md:h-[280px] lg:h-[320px] rounded-lg shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] video-glow overflow-hidden">     
    ...
    />   
        ...
        <div className="mt-16 px-4">
          <div className="bg-gradient-to-br from-[#004AAD]/5 to-[#973cff]/5 rounded-2xl p-8 md:p-12 relative overflow-hidden">
            {/* Background decorative elements */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <div className="absolute w-32 h-32 bg-gradient-to-br from-[#004AAD]/10 to-[#973cff]/10 rounded-full blur-xl -top-16 -left-16"></div>
              <div className="absolute w-24 h-24 bg-gradient-to-br from-[#973cff]/15 to-[#004AAD]/15 rounded-full blur-lg -bottom-12 -right-12"></div>
            </div>

            <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
              {/* Left Content */}
              <div className="text-center md:text-left">
                <div className="inline-flex items-center gap-2 bg-[#004AAD]/10 text-[#004AAD] px-4 py-2 rounded-full text-sm font-medium mb-4">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                  ...
                  <span className="bg-gradient-to-r from-[#004AAD] to-[#973cff] bg-clip-text text-transparent"> Fashion AI</span>
                </h2>
                
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  Join us in revolutionizing the fashion industry with AI-powered personalization. 
                  We're seeking visionary investors to help scale Racan AI globally and transform 
                  how millions discover their perfect style.
                </p>

                {/* Investment Highlights */}
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="text-center p-4 bg-white/50 rounded-lg backdrop-blur-sm">
                    <div className="text-2xl font-bold text-[#004AAD]">150K+</div>
                    <div className="text-sm text-gray-600">Active Users</div>
                  </div>
                  <div className="text-center p-4 bg-white/50 rounded-lg backdrop-blur-sm">
                    <div className="text-2xl font-bold text-[#973cff]">98%</div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <a
                    href="mailto:ssbkfdurga17@gmail.com?subject=Investment Inquiry - Racan AI&body=Hello Racan AI Team,%0D%0A%0D%0AI am interested in learning more about investment opportunities with Racan AI. Please provide me with more information about your funding round.%0D%0A%0D%0AThank you."
                    className="inline-flex items-center justify-center bg-[#004AAD] text-white px-6 py-3 rounded-full hover:bg-[#973cff] transition-all duration-300 transform hover:scale-105 hover:shadow-lg font-medium"
                  >
                  ...
                  <button
                    onClick={() => window.location.href = 'https://chat-with-racan.vercel.app'}
                    className="inline-flex items-center justify-center border-2 border-[#004AAD] text-[#004AAD] px-6 py-3 rounded-full hover:bg-[#004AAD] hover:text-white transition-all duration-300 font-medium"
                  >
                    Try Our Platform
                  </button>
                </div>
              ...
              <div className="relative">
                <div className="relative w-full max-w-md mx-auto">
                  ...
                  <div className="bg-white rounded-2xl p-6 shadow-xl transform hover:scale-105 transition-transform duration-300">
                    {/* Investment themed illustration */}
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex-1 mx-3 bg-gray-200 rounded-full h-2">
                          <div className="bg-gradient-to-r from-[#004AAD] to-[#973cff] h-2 rounded-full w-4/5"></div>
                        </div>
                        <span className="text-sm font-medium text-[#004AAD]">80%</span>
                      </div>
                      
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-600">Revenue</span>
                        <div className="flex-1 mx-3 bg-gray-200 rounded-full h-2">
                          <div className="bg-gradient-to-r from-[#973cff] to-[#004AAD] h-2 rounded-full w-3/5"></div>
                        </div>
                        <span className="text-sm font-medium text-[#973cff]">60%</span>
                      </div>
                      
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-600">Market Share</span>
                        <div className="flex-1 mx-3 bg-gray-200 rounded-full h-2">
                          <div className="bg-gradient-to-r from-[#004AAD] to-[#973cff] h-2 rounded-full w-2/3"></div>
                        </div>
                        <span className="text-sm font-medium text-[#004AAD]">65%</span>
                      </div>
                    </div>
                  </div>
            ...
            <div className="mt-12 pt-8 border-t border-gray-200/50">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                <div>
                  <div className="text-2xl font-bold text-[#004AAD] mb-1">$2M+</div>
                  <div className="text-sm text-gray-600">Market Opportunity</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-[#973cff] mb-1">5+</div>
                  <div className="text-sm text-gray-600">Team Members</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-[#004AAD] mb-1">3</div>
                  <div className="text-sm text-gray-600">Products</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-[#973cff] mb-1">24/7</div>
